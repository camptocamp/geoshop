...
/**
 * The description of an ordered data item that is being processed and whose data must be copied for
 * archiving.
 *
 * @author Florent Krin
 */
public class ExecRequest implements ITaskProcessorRequest {
