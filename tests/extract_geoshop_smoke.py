...
GEOSHOP_BACK = os.environ.get("GEOSHOP_BACK", "https://geoshop-back:8000")
...
GEOSHOP_DEMO_LOGIN = tuple(os.environ.get("GEOSHOP_DEMO_LOGIN", "admin:Test1234").split(":"))
...
class GeoshopSmokeTest(unittest.TestCase):
    ...
    def test_geoshopFrontendLoginLogout(self):
        ...
        # Login
        self._driver.find_element(By.CSS_SELECTOR, "mat-toolbar button:nth-of-type(2)").click()
        self._driver.find_element(By.CSS_SELECTOR, ".mat-mdc-menu-content button").click()
        self._driver.find_element(By.CSS_SELECTOR, "#loginName").send_keys(GEOSHOP_DEMO_LOGIN[0])
        self._driver.find_element(By.CSS_SELECTOR, "#submit-button").click()
        self._driver.find_element(By.CSS_SELECTOR, "#password").send_keys(GEOSHOP_DEMO_LOGIN[1])
        self._driver.find_element(By.CSS_SELECTOR, "#submit-button").click()
